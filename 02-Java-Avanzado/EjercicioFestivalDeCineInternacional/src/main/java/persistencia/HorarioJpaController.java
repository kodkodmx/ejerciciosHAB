...
public class HorarioJpaController implements Serializable {
    ...
    public void create(Horario programador) {
    ...
    public void edit(Horario programador) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            Horario programador;
            try {
                programador = em.getReference(Horario.class, id);
                programador.getId();
    ...
    public List<Horario> findProgramadorEntities() {
        return findProgramadorEntities(true, -1, -1);
    }

    public List<Horario> findProgramadorEntities(int maxResults, int firstResult) {
        return findProgramadorEntities(false, maxResults, firstResult);
    }

    private List<Horario> findProgramadorEntities(boolean all, int maxResults, int firstResult) {
    ...
    public Horario findProgramador(int id) {
        EntityManager em = getEntityManager();
        try {
